...
export const ImportFileUpload = ({
  ...
  return (
    <>
      <Typography>Import {'Rootstock Safe'} data by uploading a file in the area below.</Typography>
      ...
      <Typography>
        ...
        />
        Only JSON files exported from the {'Rootstock Safe'} can be imported.
      </Typography>
    </>
  )
}

...
const STATUS_PAGE = IS_PRODUCTION
  ? 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.safe.rootstock.io'
  : 'https://tx-status-app.safe.protofire.io/?serviceUrl=https://gateway.staging.safe.rootstock.io'
